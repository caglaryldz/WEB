    ...
    public class MemberController : Controller
    {
        ...
        public IActionResult AddNewUser(CreateUserModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(nameof(model.Username), "Kullanici adi daha önceden alinmis.");
        ...
        public IActionResult EditUser(Guid id, EditUserModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(nameof(model.Username), "Kullanici adi daha önce alinmis");
                    return PartialView("_EditUserPartial", model);
                }
                ...
                return PartialView("_EditUserPartial", new EditUserModel { Done = "Kullanici güncellendi." });
            }
